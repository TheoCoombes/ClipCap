#!/usr/bin/env python
# From https://github.com/audio-captioning/caption-evaluation-tools
...
from clipcap.eval.pycocoevalcap.eval import COCOEvalCap
from clipcap.eval.pycocotools.coco import COCO
